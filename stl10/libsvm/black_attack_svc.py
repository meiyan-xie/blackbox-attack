...
class Target(object):
    ...
    def eval(self, testdata, testlabel):
        ...
        print('len of testlabel ', len(testlabel))
...
# # Get STL10 data from torch datasets
# def get_data():
...
def stl10_bbox_sub(param, target_model, substitute_model, x_sub, test_data, \
    ...
    for rho in range(aug_epoch):
        ...
        if (rho > 19 and rho % 2 == 0) or rho == aug_epoch - 1:
            ...
            torch.save(substitute_model.model.state_dict(), 'model/svcsub.t7')
